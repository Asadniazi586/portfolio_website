      ...
      <div className="container mx-auto px-4 sm:px-6 text-center z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-[11px] sm:text-xs text-gray-300 whitespace-nowrap font-medium">
          ...
          <motion.h1
            ...
            className="text-[2.5rem] sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-5 tracking-tight"
          >
            M. ASAD KHAN
          </motion.h1>
          ...
          <div className="text-xl sm:text-xl md:text-3xl text-gray-300 mb-5 sm:mb-6 px-2">
            <div className="flex justify-center items-center text-center flex-wrap sm:flex-nowrap gap-2">
              ...
              >
                ...
                <span className="invisible font-extrabold whitespace-nowrap text-xl sm:text-xl md:text-3xl block text-center">
                  {longestRole}
                </span>
              </div>
            </div>
          ...
          <motion.p
            ...
            className="text-gray-300 text-[14px] sm:text-base md:text-lg max-w-sm sm:max-w-2xl mx-auto mb-7 sm:mb-8 leading-relaxed px-4"
          >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#contact"
              className="px-6 py-2.5 rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white text-[14px] sm:text-base font-semibold shadow-lg shadow-blue-500/20"
            >
              Get In Touch
            </motion.a>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              href="#projects"
              className="px-6 py-2.5 rounded-full border-2 border-blue-500 text-white text-[14px] sm:text-base font-semibold hover:bg-blue-500/10 transition-all"
            >
              View Work
            </motion.a>
          </motion.div>
          ...
          >
            {[
              ...
              <div key={i}>
                ...
                <div className="text-[10px] sm:text-xs text-gray-400 tracking-wide whitespace-nowrap font-semibold mt-1.5">
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <div className="absolute bottom-0 left-0 right-0 md:hidden">
        ...
        <div className="marquee-container overflow-hidden border-t border-gray-800 bg-black/60 backdrop-blur-sm py-4">
          <div className="marquee-track inline-flex whitespace-nowrap">
            {[
              ...
              <span key={i} className="mx-3 text-[13px] text-white font-bold tracking-wide">
                {tech}
              </span>
            ))}
            ...
            {[
              ...
              <span key={`dup-${i}`} className="mx-3 text-[13px] text-white font-bold tracking-wide">
                {tech}
              </span>
            ))}
          </div>
        ...
        <div className="flex flex-col items-center justify-center py-2.5 bg-black/40 backdrop-blur-sm">
          ...
          >
            ...
            <span className="text-white/50 text-[8px] tracking-wider font-semibold mt-1">SCROLL</span>
          </motion.div>
        </div>
      </div>
    </section>
